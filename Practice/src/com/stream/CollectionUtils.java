...
import static com.stream.Category.FRUITS;
import static com.stream.Category.GRAINS;
import static com.stream.Category.OIL;
...
public interface CollectionUtils {
	 static List<Product> populateData() {
		...
		products.add(new Product(102, "apple", FRUITS, parse("2020-01-01"), 450));
